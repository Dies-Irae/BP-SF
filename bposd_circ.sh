...
echo ""
echo "Running [[126,12,10]] memory experiment (BP1000-OSD10)"
python cbb_test.py \
    --d 10 \
...
echo ""
echo "Running [[154,6,16]] memory experiment (BP1000-OSD10)"
python cbb_test.py \
    --d 16 \
    --num_processes $NUM_PROCESSES \
    --l 7 \
...
echo "Running [[288,12,18]] memory experiment (BP1000-OSD10)"
python test.py \
    --d 18 \
    --num_processes $NUM_PROCESSES \
    --l 12 \
...
echo ""
echo "Running [[72,12,6]] memory experiment (BP1000-OSD10)"
python test.py \
    --d 6 \
    --num_processes $NUM_PROCESSES \
    --l 6 \
...
echo ""
echo "Running [[144,12,12]] memory experiment (BP1000-OSD10)"
python test.py \
    --d 12 \
    --num_processes $NUM_PROCESSES \
    --l 12 \
